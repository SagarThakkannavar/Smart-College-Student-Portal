...
def student_feedback(request):
    ...
    # Mark all replies as read when student visits feedback page
    FeedbackStudent.objects.filter(student=student).exclude(reply='').update(reply_read=True)
...
def student_view_result(request):
    ...
    average_percentage = round(total_marks / (total_subjects * 100) * 100, 2) if total_subjects > 0 else 0
