...
def send_student_notification(request):
    ...
    try:
        # Send Firebase notification (existing functionality)
        ...
        email_subject = "MMEC College Portal - New Notification"
        email_message = f"""Dear {student.admin.first_name} {student.admin.last_name},

You have received a new notification from MMEC College Portal:
...
def send_staff_notification(request):
    ...
    try:
        ...
        # Send email notification (new functionality)
        email_subject = "MMEC College Portal - New Notification"
        email_message = f"""Dear {staff.admin.first_name} {staff.admin.last_name},

You have received a new notification from MMEC College Portal:

{message}

Please log in to your staff dashboard to view more details.
...
MMEC College Administration"""
        ...
        send_mail(
            ...
            message=email_message,
            from_email=settings.DEFAULT_FROM_EMAIL,
            recipient_list=[staff.admin.email],
            fail_silently=False,
        )
