...
urlpatterns = [
    ...
    path('student/view/result/', student_views.student_view_result,
     ...
     path('export/attendance/filtered/', views.export_attendance_csv_filtered,     
          name='export_attendance_csv_filtered'),
      path('export_staff_csv/', views.export_staff_csv, 
          name='export_staff_csv'),
     path('export_results_csv/', views.export_results_csv, 
